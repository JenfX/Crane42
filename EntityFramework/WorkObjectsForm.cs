...
{
    public partial class WorkObjectsForm : Form
    {
        private const string table = "WorkObjects"; //НЕ ЗАБЫВАТЬ ПРОВЕРЯТЬ НАЗВАНИЯ!!!
        ...
        private void LoadData()
        {
            try
            {
                sqlDataAdapter = new SqlDataAdapter("SELECT *, 'Delete' AS [DELETE] FROM WorkObjects", sqlConnection);
